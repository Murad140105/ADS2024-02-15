package by.it.group310902.nazarov.lesson01.lesson11;
...
public class MyHashSet<E> implements Set<E> {
    ...
    private int count;// Текущее количество элементов в множестве
        ...
        while (current != null) {
            if (current.data.equals(o)) {
                if (previous == null) {
                    ...
                    previous.next = current.next;//удаление текуший узел
                }
                count--;
                return true;
            }
    ...
    @Override
    public void clear() {
        // Очищаем массив и сбрасываем счетчик
        for (int i = 0; i < elements.length; i++)
            elements[i] = null;
        count = 0;
    }
